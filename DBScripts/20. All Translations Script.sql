...
UNION SELECT 'ViewBusStopsDownload',N'View bus stop locations, bus timetables, city maps and great things to do in {2} with our free app – available now from the {0} or {1}',N'Consultez l''emplacement des arrêts de bus, les horaires des bus, des plans de la ville et les choses à ne pas manquer à {2} depuis notre application gratuite, dorénavant disponible sur {0} ou {1}',N'Revise las paradas de autobús, horarios, mapas de las ciudades y las visitas que puede hacer en {2}, con nuestra aplicación gratuita ya disponible desde el  {0} o {1}',N'Nézze meg a buszmegállók helyszíneit, a buszok menetrendjét, a várostérképeket vagy {2} legjobb programjait ingyenes alkalmazásunkkal, amelyet innen tölthet le: {0} vagy {1}',N'利用我们的免费应用程序查看巴士站点位置、巴士班次时间表、城市地图及 {2} 中的好去处，应用程序现已在 {0} 或 {1} 上提供。',N'利用我們的免費應用程式查看巴士站點位置、巴士班次時間表、城市地圖及 {2} 中的好去處，應用程式現已在 {0} 或 {1} 上提供。',N'Infos zu unseren Bushaltestellen, Busfahrpläne, Stadtpläne und Aktivitäten in {2} erhalten Sie auf unserer kostenlosen App – jetzt im {0} oder {1} erhältlich'
