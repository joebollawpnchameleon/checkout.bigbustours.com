...
namespace bigbus.checkout.Controllers
{
    public class MagentoTestController : ApiController
    {
        ...
        public HttpResponseMessage Get(string id)
        {
            ...
            @"{
            ""items"":[
             {""name"":""1 Day Tour - Good"",""sku"":""1348"",""ProductDimensionUID"":""c4bf36f4-acf4-4da8-b8ca-f4f9ce9345a0"",""qty"":2,""price"":29.99,""discount"":0,""total"":59.98,""city"":""London"",""type"":""adult""},            
