<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewVoucher.aspx.cs" MasterPageFile="~/SiteMaster.Master" Inherits="bigbus.checkout.ViewVoucher" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   <%@ Page Language="C#" AutoEventWireup="true" CodeBehind="voucher.aspx.cs" Inherits="BigBusWebsite.Voucher" %>
